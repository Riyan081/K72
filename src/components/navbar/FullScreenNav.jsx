      ...
      <div ref={fullNavLinksRef} className="relative">
        <div className="navlink flex w-full justify-between lg:p-5 p-2 items-start">
          ...
          <div
            ...
            className="lg:h-16 h-20 w-20 lg:w-22 relative cursor-pointer "
          >
        ...
        <div className=" lg:py-2 pt-30">
          <div className="link origin-top relative border-t-1 border-white overflow-hidden">
            <h1 className="font-[font2] text-7xl p-5 lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 uppercase">
              Projets
            </h1>
            <div className="moveLink absolute text-black flex top-0 left-0 w-full h-full bg-[#D3FD50]">
              <div className="moveX flex items-center">
                <h2 className="whitespace-nowrap font-[font2] text-7xl p-5 lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 uppercase">
                  Pour Tout voir
                </h2>
                <img
